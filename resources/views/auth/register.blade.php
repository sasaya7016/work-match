...
<div class="signupPage">
  ...
  <div class='container'>
    ...
    @csrf
      ...
      <div class="form-group">
        <div><label>登録書</label></div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" name="number" value="0" type="radio" id="inlineRadio1" checked>
          <label class="form-check-label" for="inlineRadio1">就業者</label>
        </div>
        <div class="form-check form-check-inline">
        <input class="form-check-input" name="number" value="1" type="radio" id="inlineRadio2">
